...
class WaveController(Node):
    def __init__(self):
        ...
        self.get_logger().info("👋 Wave Controller Node Online!")

        # Listen for trigger from Coordinator
        self.trigger_sub = self.create_subscription(
            Empty, '/gesture/wave', self.execute_wave_callback, 10)
    ...
    def execute_wave_callback(self, msg):
        self.get_logger().info("Processing Wave Trajectory...")
